...
export default function Home() {
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      {/* Decorative floating shapes - hidden on mobile for cleaner look */}
      <div className="hidden sm:block absolute top-20 left-12 w-12 h-12 sm:w-16 sm:h-16 bg-orange-500 rounded"></div>
      <div className="hidden sm:block absolute top-80 left-20 w-16 h-12 sm:w-24 sm:h-16 bg-pink-300 rounded"></div>
      <div className="hidden lg:block absolute top-[500px] left-8 w-16 h-16 sm:w-20 sm:h-20 bg-yellow-400 rounded"></div>
      <div className="hidden sm:block absolute top-32 right-20 w-16 h-16 sm:w-20 sm:h-20 bg-cyan-200 rounded"></div>
      <div className="hidden lg:block absolute top-[400px] right-32 w-16 h-12 sm:w-24 sm:h-16 bg-pink-300 rounded"></div>
      <div className="hidden lg:block absolute top-[600px] right-12 w-12 h-12 sm:w-16 sm:h-16 bg-yellow-400 rounded"></div>
      <div className="hidden sm:block absolute bottom-32 right-40 w-16 h-16 sm:w-20 sm:h-20 bg-cyan-200 rounded"></div>

      {/* Header */}
      <header className="flex items-center justify-between px-4 sm:px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          <button className="text-gray-600 hover:text-gray-800 text-sm sm:text-base">Login</button>
          <button className="bg-blue-600 text-white px-3 sm:px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
            Request Demo
          </button>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
        {/* Announcement banner */}
        <div className="bg-yellow-400 text-black px-4 sm:px-6 py-3 rounded-lg mb-8 sm:mb-12 text-center font-mono text-xs sm:text-sm">
          <span className="hidden sm:inline">THE FUTURE OF APPS JUST ACCELERATED: ADOPT AI DELIVERS ZERO-SHOT AGENTS, TODAY. →</span>
          <span className="sm:hidden">ADOPT AI: ZERO-SHOT AGENTS TODAY →</span>
        </div>
        ...
        <div className="bg-blue-600 rounded-2xl sm:rounded-3xl px-6 sm:px-12 py-12 sm:py-16 text-center text-white relative overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto">
            {/* 3D cubes with labels - hidden on mobile for clarity */}
            <div className="hidden md:block absolute top-12 left-16 perspective-1000">
            ...
            <div className="hidden md:block absolute top-32 left-8 perspective-1000">
            ...
            <div className="hidden md:block absolute bottom-16 left-12 perspective-1000">
            ...
            <div className="hidden md:block absolute top-12 right-16 perspective-1000">
            ...
            <div className="hidden md:block absolute bottom-20 right-16 perspective-1000">
            ...
            <div className="hidden md:block absolute top-40 right-8 perspective-1000">
            ...
            {/* Central avatar */}
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-12 h-12 sm:w-16 sm:h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 rounded-full flex items-center justify-center">
                <span className="text-white text-sm sm:text-lg">✨</span>
              </div>
            </div>

            {/* Dotted connection lines - hidden on mobile */}
        ...
        <div className="mt-16 sm:mt-24 text-center">
          <p className="text-gray-500 text-base sm:text-lg mb-6 sm:mb-8">Trusted by the best</p>
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-12 opacity-60 grayscale">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-800 rounded"></div>
              <span className="text-base sm:text-xl font-semibold text-gray-800">truefoundry</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-600 rounded-full"></div>
              <span className="text-base sm:text-xl font-semibold text-gray-800">Spendflo</span>
            </div>
            <div className="text-base sm:text-xl font-semibold text-gray-800">moengage</div>
            <div className="flex items-center space-x-1">
              <span className="text-base sm:text-xl font-semibold text-gray-800">6sense</span>
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-500 rounded-full"></div>
            </div>
            <div className="text-base sm:text-xl font-semibold text-gray-800">&gt;&gt; rocketlane</div>
            <div className="text-base sm:text-xl font-semibold text-gray-800">zluri</div>
          </div>
        </div>
      </main>
